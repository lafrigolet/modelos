...
# Add arguments
parser.add_argument('-f', '--file'   , type=str, help='Path to the source file')
parser.add_argument('-t', '--target' , type=str, help='Target dir to deploy segemented images')
parser.add_argument('-g', '--height' , type=int, help='Height in pixels for the rounding box')
parser.add_argument('-w', '--width'  , type=int, help='Width in pixels for the rounding box')
...
crop_page_to_dir(args.file, args.target, args.height, args.width);
