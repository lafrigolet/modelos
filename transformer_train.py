...
def load(model, ptf) -> None:
    model.load_state_dict(torch.load(ptf)) # load best model states
...
with TemporaryDirectory() as tempdir:
    ...
    for epoch in range(1, epochs + 1):
        ...
        train(model, train_data, criterion, lr, optimizer, scheduler, epoch, ntokens)
