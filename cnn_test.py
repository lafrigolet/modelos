...
# ./cnn_train.py -p ./machinehand_dataset.tensor -o ./machinehand_model.cnn.pth -s 1000 -w 150 -t 40

# ./cnn_test.py -p ./suicide_dataset.tensor -o ./suicide_model.cnn.pth -s 1000 -w 150 -t 40

# ./cnn_test.py -p ./suicide_dataset.small.tensor -o ./suicide_model.small.cnn.pth -s 1000 -w 150 -t 40

# ./cnn_test.py -p ./osborne_dataset.tensor -o ./osborne_model.cnn.pth -s 1000 -w 150 -t 40
